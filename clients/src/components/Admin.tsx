...
import { filterUsers, resetSearch, setSearchTerm } from "../store/reducer/reducer";
export default function Admin() {
  ...
  const handleBlockUser = (item: any) => {
    const confirmBlock = window.confirm(`Bạn có chắc chắn muốn ${item.block ? 'bỏ chặn' : 'chặn'} người dùng này không?`);
    if (confirmBlock) {
